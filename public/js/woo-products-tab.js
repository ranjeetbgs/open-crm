...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    load: function load() {
      ...
      var p3 = axios.get('woocommerce/unsynced-count').then(function (_ref3) {
        var data = _ref3.data;
    ...
    manualSync: function manualSync(onlyUnsynced) {
      var _this2 = this;
      this.syncing = true;
      var url = 'woocommerce/sync/products?mode=push';
...
var render = function render() {
  ...
  return _c("div", [_c("b-row", [_c("b-col", {
    ...
    staticClass: "h5 mb-0"
  }, [_vm._v(_vm._s(_vm.totalProductsDisplay))]), _vm._v(" "), _c("small", {
    staticClass: "text-muted"
  }, [_vm._v(_vm._s(_vm.$t("Total_Products")))])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "3",
      sm: "6"
    ...
    staticClass: "text-muted"
  }, [_vm._v(_vm._s(_vm.$t("Synced_Products")))])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "3",
      sm: "6"
