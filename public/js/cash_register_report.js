...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    'date-range-picker': (vue2_daterange_picker__WEBPACK_IMPORTED_MODULE_1___default())
  },
  data: function data() {
    return {
      isLoading: true,
  ...
  methods: {
    ...
    formatMoney: function formatMoney(x) {
      try {
        ...
        return (0,_utils_priceFormat__WEBPACK_IMPORTED_MODULE_4__.formatPriceDisplay)(n, 2, effectiveKey);
      } catch (e) {
    ...
    formatDate: function formatDate(x) {
      ...
      var dateFormat = this.$store.getters.getDateFormat || _utils__WEBPACK_IMPORTED_MODULE_3__["default"].getDateFormat(this.$store);
      // formatDisplayDate now handles time preservation automatically
      return _utils__WEBPACK_IMPORTED_MODULE_3__["default"].formatDisplayDate(x, dateFormat);
    },
