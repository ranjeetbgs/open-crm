  ...
  methods: {
    ...
    Get_Provider: function Get_Provider() {
      ...
      axios.get("providers/" + id).then(function (response) {
        var _response$data$provid, _response$data$provid2, _response$data$provid3, _response$data$provid4, _response$data$provid5, _response$data$provid6, _response$data$provid7, _response$data$provid8;
