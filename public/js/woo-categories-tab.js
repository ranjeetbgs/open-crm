  ...
  methods: {
    load: function load() {
      ...
      var p1 = axios.get('woocommerce/settings').then(function (_ref) {
        var data = _ref.data;
        if (data.settings) _this.last_sync_at = data.settings.last_sync_at;
      });
      var p2 = axios.get('categories', {
        params: {
          limit: 1
        }
      }).then(function (_ref2) {
      ...
      var p3 = axios.get('woocommerce/categories/unsynced-count').then(function (_ref3) {
        var data = _ref3.data;
        _this.unsyncedCount = data.count;
      });
      return Promise.all([p1, p2, p3]);
    },
    manualSync: function manualSync(onlyUnsynced) {
      var _this2 = this;
      this.syncing = true;
      var url = 'woocommerce/sync/categories?mode=push';
      if (onlyUnsynced) url += '&only_unsynced=1';
      axios.post(url).then(function (_ref4) {
        var data = _ref4.data;
        if (data.ok) _this2.toast('success', _this2.$t('Sync_Completed'));else _this2.toast('danger', _this2.$t('Sync_Failed'));
      })["catch"](function () {
...
var render = function render() {
  ...
  return _c("div", [_c("b-row", [_c("b-col", {
    ...
    staticClass: "h5 mb-0"
  }, [_vm._v(_vm._s(_vm.totalCategoriesDisplay))]), _vm._v(" "), _c("small", {
    staticClass: "text-muted"
  }, [_vm._v(_vm._s(_vm.$t("Total_Categories")))])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "3",
      sm: "6"
    ...
    staticClass: "h5 mb-0"
  }, [_vm._v(_vm._s(_vm.syncedCategoriesDisplay))]), _vm._v(" "), _c("small", {
    staticClass: "text-muted"
  }, [_vm._v(_vm._s(_vm.$t("Synced_Categories")))])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "3",
      sm: "6"
    ...
    staticClass: "text-muted"
  }, [_vm._v(_vm._s(_vm.$t("Not_Synced")))])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      md: "3",
      sm: "6"
    ...
    staticClass: "text-muted"
  }, [_vm._v(_vm._s(_vm.$t("Last_Sync")))])])], 1)], 1), _vm._v(" "), _c("b-row", {
    staticClass: "mb-3"
  }, [_c("b-col", {
    attrs: {
      md: "12"
    ...
    staticClass: "mr-2 mb-2 d-inline-flex align-items-center",
    attrs: {
      variant: "info",
