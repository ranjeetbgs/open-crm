  ...
  methods: {
    ...
    fetchProgress: function fetchProgress() {
      ...
      axios.get('woocommerce/sync/stock/progress', {
        ...
        var data = _ref3.data;
        if (data && data.state) {
          _this3.progress = data.state;
          if (_this3.progress.finished) {
            clearInterval(_this3.poller);
            _this3.poller = null;
            _this3.syncing = false;
            _this3.toast('success', _this3.$t('Sync_Completed'));
            _this3.fetchMetrics();
...
var render = function render() {
  ...
  return _c("div", [_c("b-row", {
  ...
  }, [!_vm.syncing ? [_vm._v(_vm._s(_vm.$t("Sync_Stock_Now")))] : [_c("span", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("Refresh")))])], 1)])], 1), _vm._v(" "), _c("b-row", {
    staticClass: "mb-3"
  }, [_c("b-col", {
    staticClass: "mb-2",
    attrs: {
    ...
    staticClass: "h5 mb-0"
  }, [_vm._v(_vm._s(_vm.metrics.in_stock))]), _vm._v(" "), _c("small", [_vm._v("🟢 " + _vm._s(_vm.$t("In_Stock")))])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-2",
    attrs: {
      md: "4",
      sm: "12"
    ...
    staticClass: "h5 mb-0"
  }, [_vm._v(_vm._s(_vm.metrics.out_stock))]), _vm._v(" "), _c("small", [_vm._v("🔴 " + _vm._s(_vm.$t("Out_of_Stock")))])])], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-2",
    attrs: {
      md: "4",
      sm: "12"
    ...
    staticClass: "h6 mb-0"
  }, [_vm._v(_vm._s(_vm.formatDate(_vm.metrics.last_sync) || "-"))]), _vm._v(" "), _c("small", [_vm._v("🕒 " + _vm._s(_vm.$t("Last_Sync")))])])], 1)], 1), _vm._v(" "), _vm.syncing ? _c("b-row", [_c("b-col", {
    attrs: {
      md: "12"
    }
  }, [_c("b-progress", {
    ...
    staticClass: "ml-2"
  }, [_vm._v(_vm._s(_vm.$t("Syncing_Products")) + "... " + _vm._s(_vm.progress.percentage) + "% (" + _vm._s(_vm.progress.synced_products) + " / " + _vm._s(_vm.progress.total_products) + ")")])]), _vm._v(" "), _vm.progress.failed_products > 0 ? _c("div", {
    staticClass: "mt-2 small text-muted"
  }, [_vm._v("\n        " + _vm._s(_vm.$t("Errors")) + ": " + _vm._s(_vm.progress.failed_products) + "\n        "), _c("b-link", {
    on: {
      click: function click($event) {
        return _vm.$emit("view-logs");
      }
    }
  }, [_vm._v(_vm._s(_vm.$t("View_Logs")))])], 1) : _vm._e()], 1)], 1) : _vm._e()], 1);
};
var staticRenderFns = [];
