...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
  ...
  data: function data() {
    ...
    }, "detailLoading", false), "isOnline", true), "offlineSyncInProgress", false), "offlineSalesCount", 0), "offlineLastSyncError", null), "onlineReloadModalVisible", false), "onlineReloadAfterSale", false), "reloadAfterOfflineSync", false);
  },
  ...
  'invoice_pos.zatca_qr': function invoice_posZatca_qr(val) {
    ...
    if (val) {
      this.$nextTick(function () {
        return _this4.renderZatcaQrPos();
      });
    }
  }
}), "mounted", function mounted() {
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            params = {};
            if (_this5.sale && _this5.sale.warehouse_id) params.warehouse_id = _this5.sale.warehouse_id;
            _context.n = 2;
            return axios.get("cash-registers/current/".concat(_this5.currentUser.id), {
              params: params
            });
          case 2:
            _yield$axios$get = _context.v;
            data = _yield$axios$get.data;
            _this5.currentRegister = data.register || null;
            _context.n = 4;
            break;
          case 3:
            _context.p = 3;
            _t = _context.v;
            _this5.currentRegister = null;
          case 4:
            return _context.a(2);
        }
      }, _callee, null, [[0, 3]]);
  ...
  _cd_queue_broadcast: function _cd_queue_broadcast() {
    ...
    this._cd_broadcast_timer = setTimeout(function () {
      var payload = {
        currency: _this6.currentUser && _this6.currentUser.currency || '',
        discount: _this6.sale && _this6.sale.discount ? _this6.sale.discount : 0,
        TaxNet: _this6.sale && _this6.sale.TaxNet ? _this6.sale.TaxNet : 0,
        shipping: _this6.sale && _this6.sale.shipping ? _this6.sale.shipping : 0,
        GrandTotal: _this6.GrandTotal || 0,
        details: (_this6.details || []).map(function (d) {
          return {
            name: d.name,
            quantity: d.quantity,
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            if (_this7.registerForm.warehouse_id) {
              _context2.n = 1;
              break;
            }
            _this7.makeToast('warning', _this7.$t('Please_select_warehouse'), _this7.$t('Warning'));
            return _context2.a(2);
          case 1:
            _this7.registerBusy = true;
            _context2.p = 2;
            _context2.n = 3;
            return axios.post('cash-registers/open', {
              user_id: _this7.currentUser.id,
              warehouse_id: _this7.registerForm.warehouse_id,
              opening_balance: _this7.registerForm.opening_balance || 0,
              notes: _this7.registerForm.notes || ''
            });
          case 3:
            _yield$axios$post = _context2.v;
            data = _yield$axios$post.data;
            _this7.$bvModal.hide('OpenRegisterModal');
            _this7.makeToast('success', _this7.$t('RegisterOpened'), _this7.$t('Success'));
            // Immediately reflect UI without waiting for fetch
            _this7.currentRegister = data && data.register ? data.register : _this7.currentRegister;
            // Fallback refresh to ensure latest from server
            _this7.refreshCurrentRegister();
            _context2.n = 5;
            break;
          case 4:
            _context2.p = 4;
            _t2 = _context2.v;
            msg = ((_e$response = _t2.response) === null || _e$response === void 0 || (_e$response = _e$response.data) === null || _e$response === void 0 ? void 0 : _e$response.message) || _this7.$t('OperationFailed');
            _this7.makeToast('danger', msg, _this7.$t('Failed'));
          case 5:
            _context2.p = 5;
            _this7.registerBusy = false;
        ...
        while (1) switch (_context3.p = _context3.n) {
          ...
          case 1:
            ...
            return axios.post('cash-registers/close', {
              register_id: _this8.currentRegister.id,
              counted_cash: _this8.closeForm.counted_cash || 0,
              notes: _this8.closeForm.notes || ''
            });
          case 3:
            _this8.$bvModal.hide('CloseRegisterModal');
            _this8.makeToast('success', _this8.$t('RegisterClosed'), _this8.$t('Success'));
          ...
          case 4:
            _context3.p = 4;
            _t3 = _context3.v;
            msg = ((_e$response2 = _t3.response) === null || _e$response2 === void 0 || (_e$response2 = _e$response2.data) === null || _e$response2 === void 0 ? void 0 : _e$response2.message) || _this8.$t('OperationFailed');
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          case 0:
            ...
            _this9.savedPaymentMethods = [];
            _this9.submit_showing_credit_card = true;
            _this9.selectedCard = null;
            _this9.card_id = '';
            // Check if the customer has saved payment methods
            _context4.n = 1;
            return axios.get("/retrieve-customer?customerId=".concat(_this9.selectedClientId)).then(function (response) {
              // If the customer has saved payment methods, display them
              _this9.savedPaymentMethods = response.data.data;
              _this9.card_id = response.data.customer_default_source;
              _this9.hasSavedPaymentMethod = true;
              _this9.useSavedPaymentMethod = true;
              _this9.is_new_credit_card = false;
              _this9.submit_showing_credit_card = false;
            })["catch"](function (error) {
              // If the customer does not have saved payment methods, show the card element for them to enter their payment information
              _this9.hasSavedPaymentMethod = false;
              _this9.useSavedPaymentMethod = false;
              _this9.is_new_credit_card = true;
              _this9.card_id = '';
              setTimeout(function () {
                _this9.loadStripe_payment();
              }, 1000);
              _this9.submit_showing_credit_card = false;
            });
          case 1:
    ...
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          case 0:
            _context5.n = 1;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_6__.loadStripe)("".concat(_this1.stripe_key));
          case 1:
            _this1.stripe = _context5.v;
            elements = _this1.stripe.elements();
            _this1.cardElement = elements.create("card", {
              classes: {
                base: "bg-gray-100 rounded border border-gray-300 focus:border-indigo-500 text-base outline-none text-gray-700 p-3 leading-8 transition-colors duration-200 ease-in-out"
              }
            });
            _this1.cardElement.mount("#card-element");
          case 2:
            return _context5.a(2);
        }
      }, _callee5);
  ...
  axios.post("pos/create_draft", {
    ...
    if (response.data.success === true) {
      _this10.makeToast("success", _this10.$t("Draft_Created_successfully"), _this10.$t("Success"));
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      _this10.DraftProcessing = false;
      _this10.Reset_Pos();
    }
  })["catch"](function (error) {
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
  ...
  var anyNewCard = this.paymentLines.some(function (p) {
    return (p.payment_method_id === '1' || p.payment_method_id === 1) && _this11.is_new_credit_card;
  });
  if (anyNewCard) {
    if (this.stripe_key !== '') {
      this.processPayment();
    ...
    axios.post("pos/create_pos", {
      ...
      if (response.data.success === true) {
        ...
        var draftId = _this11.draft_sale_id;
        var afterCleanup = function afterCleanup() {
          _this11.Invoice_POS(saleId);
  ...
  var _this12 = this;
  return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
    var _yield$_this12$stripe, paymentMethod, error, paymentsWithMethod;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.n) {
        case 0:
          _this12.paymentProcessing = true;
          _context6.n = 1;
          return _this12.stripe.createPaymentMethod({
            type: "card",
            card: _this12.cardElement,
            billing_details: {
              name: _this12.client_name || ""
            }
          });
        case 1:
          _yield$_this12$stripe = _context6.v;
          paymentMethod = _yield$_this12$stripe.paymentMethod;
          ...
          if (error) {
            ...
            paymentsWithMethod = _this12.paymentLines.map(function (p) {
            ...
            axios.post("pos/create_pos", {
              ...
              send_email: _this12.sendEmail,
              send_sms: _this12.sendSMS,
              account_id: _this12.selectedAccount,
              payment_note: _this12.globalPaymentNote || "",
              ...
              draft_sale_id: _this12.draft_sale_id || undefined
            }).then(function (response) {
              _this12.paymentProcessing = false;
              if (response.data.success === true) {
                nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    ...
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.n) {
        case 0:
          ...
          warehouseId = _this13.sale && _this13.sale.warehouse_id ? _this13.sale.warehouse_id : null;
          applyDetail = function applyDetail(data) {
            if (!data) return;
            _this13.product.discount = data.discount;
            _this13.product.DiscountNet = data.DiscountNet;
            _this13.product.discount_Method = data.discount_method;
            _this13.product.product_id = data.id;
            _this13.product.product_type = data.product_type;
            _this13.product.name = data.name;
            _this13.product.Net_price = data.Net_price;
            _this13.product.Total_price = data.Total_price;
            _this13.product.Unit_price = data.Unit_price;
            _this13.product.Unit_price_wholesale = data.Unit_price_wholesale;
            _this13.product.wholesale_Net_price = data.wholesale_Net_price;
            _this13.product.min_price = data.min_price || 0;
            _this13.product.retail_unit_price = data.Unit_price;
            _this13.product.wholesale_unit_price = data.Unit_price_wholesale;
            _this13.product.price_type = 'retail';
            _this13.product.taxe = data.tax_price;
            _this13.product.tax_method = data.tax_method;
            _this13.product.tax_percent = data.tax_percent;
            _this13.product.unitSale = data.unitSale;
            _this13.product.product_variant_id = variant_id;
            _this13.product.code = data.code;
            _this13.product.fix_price = data.fix_price;
            _this13.product.sale_unit_id = data.sale_unit_id;
            _this13.product.is_imei = data.is_imei;
            _this13.product.imei_number = '';

            // Set current stock quantity from warehouse data (already adjusted for shadow stock if applied below)
            _this13.product.current = data.qte_sale || 0;
            _this13.product.fix_stock = data.qte || 0;

            // Ensure a valid default quantity when adding directly from the grid
            if (_this13.product.product_type === 'is_service') {
              _this13.product.quantity = 1;
            } else if (_this13.product.quantity === undefined || _this13.product.quantity === null || _this13.product.quantity <= 0) {
              _this13.product.quantity = _this13.product.current < 1 ? _this13.product.current : 1;
            }
            _this13.add_product(data.code);
            _this13.CalculTotal();
          };
          reallyOffline = !_this13.isOnline || typeof window !== 'undefined' && window.navigator && window.navigator.onLine === false; // Helper: build a detail object from a sourceProduct row that came
  ...
  var existingIndex = this.details.findIndex(function (d) {
    ...
    if (hasProductIds && rowHasId) {
      return d.product_id === _this14.product.product_id && dVariant === targetVariantId && d.sale_unit_id === _this14.product.sale_unit_id;
    }
    // Fallback to matching by code + unit when ids are not available
    return d.code === _this14.product.code && d.sale_unit_id === _this14.product.sale_unit_id;
  });
  if (existingIndex !== -1) {
  ...
  this.Get_Product_Details(product.id, product.product_variant_id, product)["catch"](function () {})["finally"](function () {
    ...
    if (_this16.uiLoadingProductId === key) _this16.uiLoadingProductId = null;
  });
  ...
  this.get_units(detail.product_id)["catch"](function () {})["finally"](function () {
    _this17.detail.detail_id = detail.detail_id;
    _this17.detail.sale_unit_id = detail.sale_unit_id;
    _this17.detail.product_type = detail.product_type;
    _this17.detail.Unit_price = detail.Unit_price;
    _this17.detail.price_type = detail.price_type || 'retail';
    _this17.detail.retail_unit_price = detail.retail_unit_price !== undefined ? detail.retail_unit_price : detail.Unit_price;
    _this17.detail.wholesale_unit_price = detail.wholesale_unit_price !== undefined ? detail.wholesale_unit_price : detail.Unit_price_wholesale;
    _this17.detail.min_price = detail.min_price !== undefined ? detail.min_price : 0;
    _this17.detail.fix_price = detail.fix_price;
    _this17.detail.fix_stock = detail.fix_stock;
    _this17.detail.current = detail.current;
    _this17.detail.tax_method = detail.tax_method;
    _this17.detail.discount_Method = detail.discount_Method;
    _this17.detail.discount = detail.discount;
    _this17.detail.quantity = detail.quantity;
    _this17.detail.tax_percent = detail.tax_percent;
    _this17.detail.is_imei = detail.is_imei;
    _this17.detail.imei_number = detail.imei_number;
    _this17.detailLoading = false;
  });
  console.log(detail);
  ...
  this.CalculTotal();
  setTimeout(function () {
    _this18.$bvModal.hide("form_Update_Detail");
  }, 1000);
  ...
  return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0() {
    ...
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        case 0:
          previousPage = _this19.product_currentPage || 1;
          _this19.details = [];
          _this19.product = {};
          _this19.draft_sale_id = '';
          _this19.paymentLines = [{
            amount: 0,
            payment_method_id: '2'
          }];
          _this19.selectedAccount = null;
          _this19.globalPaymentNote = '';
          _this19.savedPaymentMethods = [], _this19.hasSavedPaymentMethod = false, _this19.useSavedPaymentMethod = false, _this19.selectedCard = null, _this19.card_id = '', _this19.is_new_credit_card = false, _this19.submit_showing_credit_card = false, _this19.sale.tax_rate = 0;
          _this19.sale.TaxNet = 0;
          _this19.sale.shipping = 0;
          _this19.sale.discount = 0;
          _this19.sale.discount_Method = '2'; // Reset to fixed (default)
          _this19.sale.notes = '';
          _this19.GrandTotal = 0;
          _this19.total = 0;
          _this19.category_id = "";
          _this19.brand_id = "";
          _this19.selectedClientPoints = 0;
          _this19.points_to_convert = 0;
          _this19.used_points = 0;
          _this19.discount_from_points = 0;
          _this19.clientIsEligible = false;
          _this19.pointsConverted = false;
          try {
            _this19._cd_emit && _this19._cd_emit({
              currency: _this19.currentUser && _this19.currentUser.currency || '',
              details: [],
              discount: 0,
              TaxNet: 0,
              GrandTotal: 0
          ...
          client = _this19.clients.find(function (client) {
            return client.id === 1;
          });
          if (!client) {
            _context0.n = 4;
          ...
          _this19.client_name = client.name;
          _this19.selectedClientId = 1;
          _context0.p = 1;
          _context0.n = 2;
          return axios.get("/get_points_client/".concat(_this19.selectedClientId));
        case 2:
          response = _context0.v;
          data = response.data;
          if (data.is_royalty_eligible) {
            _this19.selectedClientPoints = data.points;
            _this19.clientIsEligible = true;
          } else {
            _this19.selectedClientPoints = 0;
            _this19.clientIsEligible = false;
          }
        ...
        case 6:
          ...
          _t7 = _context0.v;
        case 7:
          if (!_this19.isOnline && previousPage > 1) {
            _this19.product_currentPage = previousPage;
            _this19.paginate_products(_this19.product_perPage, previousPage - 1);
          }
        case 8:
  ...
  if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
    this.timer = setTimeout(function () {
      var barcode = _this20.search_input.trim();
      var weight = null;
      if (barcode.length === 13 && !isNaN(barcode)) {
        // Play sound only if barcode scanning sound is enabled
        if (_this20.pos_settings.barcode_scanning_sound) {
          _this20.audio.play();
        }
        // Play sound only if barcode scanning sound is enabled
        if (_this20.pos_settings.barcode_scanning_sound) {
        ...
        if (product) {
          ...
          if (_product) {
            ...
            if (available > 0 && _weight > available) {
              _this20.makeToast("warning", _this20.$t("LowStock"), _this20.$t("Warning"));
              _weight = available;
            }
            _product.quantity = _weight;
            _this20.Check_Product_Exist(_product, _product.id, _weight);
            return;
          }
        }
        _this20.makeToast("danger", "Invalid product code scanned", _this20.$t("Error"));
        _this20.search_input = '';
        _this20.product_filter = [];
      }
      var product_filter = _this20.products_pos.filter(function (product) {
        return (product.product_type === 'is_service' || Number(product.qte_sale || 0) > 0) && (product.code === _this20.search_input || String(product.barcode || '').includes(_this20.search_input));
      });
      if (product_filter.length === 1) {
        ...
        _this20.Check_Product_Exist(product_filter[0], product_filter[0].id, weight = null);
      } else {
        _this20.product_filter = _this20.products_pos.filter(function (product) {
          ...
          var term = _this20.search_input.toLowerCase();
  ...
  setTimeout(function () {
    _this21.$bvModal.show("show_draft_sales");
  }, 1000);
  ...
  axios.get("get_draft_sales?page=" + page + "&limit=" + this.limit).then(function (response) {
    _this22.draft_sales = response.data.draft_sales;
    _this22.totalRows_draft_sales = response.data.totalRows;

    // If current page is empty but we have data and we're not on page 1, go to previous page
    if (_this22.draft_sales.length === 0 && _this22.totalRows_draft_sales > 0 && page > 1) {
      _this22.draft_sales_page = page - 1;
      _this22.get_Draft_Sales(_this22.draft_sales_page);
      return;
    }
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
  })["catch"](function () {
  ...
  axios.get("pos/data_draft_convert_sale/".concat(id)).then(function (response) {
    _this23.draft_sale_id = id;
    var data = response.data || {};

    // Basic references (keep layout/logic unchanged; just inject data)
    if (Array.isArray(data.clients)) _this23.clients = data.clients;
    if (Array.isArray(data.accounts)) _this23.accounts = data.accounts;
    if (Array.isArray(data.warehouses)) _this23.warehouses = data.warehouses;
    if (Array.isArray(data.categories)) _this23.categories = data.categories;
    if (Array.isArray(data.brands)) _this23.brands = data.brands;
    if (Array.isArray(data.payment_methods)) _this23.payment_methods = data.payment_methods;

    // Customer & loyalty
    _this23.selectedClientId = data.client_id || data.sale && data.sale.client_id || _this23.selectedClientId;
    _this23.client_name = data.client_name || _this23.client_name;
    _this23.clientIsEligible = data.default_client_eligible === true || data.default_client_eligible === 1;
    _this23.selectedClientPoints = _this23.clientIsEligible ? parseFloat(data.default_client_points || 0) : 0;
    if (typeof data.point_to_amount_rate !== 'undefined') {
      _this23.point_to_amount_rate = data.point_to_amount_rate;
    }

    // Sale-level fields
    var saleData = data.sale || {};
    _this23.sale.warehouse_id = data.warehouse_id !== undefined && data.warehouse_id !== null ? data.warehouse_id : saleData.warehouse_id || _this23.sale.warehouse_id;
    _this23.sale.tax_rate = saleData.tax_rate || 0;
    _this23.sale.TaxNet = saleData.TaxNet || 0;
    _this23.sale.discount = saleData.discount || 0;
    // Backward compatibility: default to fixed ('2') if discount_Method is not present
    _this23.sale.discount_Method = saleData.discount_Method || '2';
    _this23.sale.shipping = saleData.shipping || 0;
    _this23.sale.notes = saleData.notes || '';
    ...
    _this23.details = mapped;

    // Totals
    _this23.GrandTotal = Number(data.GrandTotal || 0);
    _this23.CalculTotal();

    // Refresh product lists for the chosen warehouse (unified API)
    if (_this23.sale.warehouse_id) {
      _this23.getProducts();
    }

    // Close draft list modal
    try {
      _this23.$bvModal.hide('show_draft_sales');
    } catch (e) {}
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
  })["catch"](function () {
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
  })["finally"](function () {
    _this23.openingDraftId = null;
  });
  ...
  return axios.get("pos/get_products_pos" + "?category_id=" + this.category_id + "&brand_id=" + this.brand_id + "&warehouse_id=" + this.sale.warehouse_id + "&stock=" + 1 + "&product_service=" + 1 + "&product_combo=" + 1).then(function (response) {
    ...
    _this25.products = rawProducts.map(function (p) {
      return _objectSpread({}, p);
    });
    // Use the same unified list for barcode scanning / quick search.
    _this25.products_pos = rawProducts.map(function (p) {
      return _objectSpread({}, p);
    });
    _this25.product_totalRows = response.data.totalRows;
    _this25.Product_paginatePerPage();
    var reallyOffline = !_this25.isOnline || typeof window !== 'undefined' && window.navigator && window.navigator.onLine === false;
    if (reallyOffline) {
      try {
        if (_utils__WEBPACK_IMPORTED_MODULE_4__["default"] && _utils__WEBPACK_IMPORTED_MODULE_4__["default"].shadowStock && _utils__WEBPACK_IMPORTED_MODULE_4__["default"].shadowStock.applyToList && _this25.sale.warehouse_id) {
          _utils__WEBPACK_IMPORTED_MODULE_4__["default"].shadowStock.applyToList(_this25.sale.warehouse_id, _this25.products);
        }
      } catch (e) {}
    }
    _this25.productsReady = true;
    // Cache grid products for offline usage (per warehouse) using RAW server data
    try {
      if (_utils__WEBPACK_IMPORTED_MODULE_4__["default"] && _utils__WEBPACK_IMPORTED_MODULE_4__["default"].offlinePos && _utils__WEBPACK_IMPORTED_MODULE_4__["default"].offlinePos.cacheWarehouseSnapshot && _this25.sale.warehouse_id) {
        _utils__WEBPACK_IMPORTED_MODULE_4__["default"].offlinePos.cacheWarehouseSnapshot(_this25.sale.warehouse_id, {
          products: rawProducts,
          products_pos: rawProducts,
          product_totalRows: _this25.product_totalRows,
          lastLoadedPage: 1,
          category_id: _this25.category_id,
          brand_id: _this25.brand_id
        });
      }
    } catch (e) {}
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    ...
    try {
      if (_utils__WEBPACK_IMPORTED_MODULE_4__["default"] && _utils__WEBPACK_IMPORTED_MODULE_4__["default"].offlinePos && _utils__WEBPACK_IMPORTED_MODULE_4__["default"].offlinePos.getWarehouseSnapshot && _this25.sale.warehouse_id) {
        var snap = _utils__WEBPACK_IMPORTED_MODULE_4__["default"].offlinePos.getWarehouseSnapshot(_this25.sale.warehouse_id);
        if (snap && Array.isArray(snap.products)) {
          var baseProducts = snap.products;
          _this25.products = baseProducts.map(function (p) {
            return _objectSpread({}, p);
          });
          // Hydrate scan/search list from cached unified products if available
          if (Array.isArray(snap.products_pos)) {
            _this25.products_pos = snap.products_pos.map(function (p) {
              return _objectSpread({}, p);
            });
          } else {
            _this25.products_pos = baseProducts.map(function (p) {
              return _objectSpread({}, p);
            });
          }
          _this25.product_totalRows = snap.product_totalRows || baseProducts.length;
          _this25.Product_paginatePerPage();
          var reallyOffline = !_this25.isOnline || typeof window !== 'undefined' && window.navigator && window.navigator.onLine === false;
          if (reallyOffline) {
    ...
    _this25.productsReady = true; // avoid blocking UI forever on error
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
  })["finally"](function () {
    _this25.productsLoading = false;
  });
  ...
  return axios.get("get_units?id=" + value).then(function (_ref6) {
    ...
    _this26.units = units;
    var map = Object.assign({}, _this26.unitsByProductId || {}, _defineProperty({}, pid, units));
    _this26.unitsByProductId = map;
    var stored = loadUnitsCache();
    stored[pid] = units;
  ...
  this.$bvModal.show("form_Update_Detail");
  this.get_units(detail.product_id)["catch"](function () {})["finally"](function () {
    _this27.detail.detail_id = detail.detail_id;
    _this27.detail.sale_unit_id = detail.sale_unit_id;
    _this27.detail.product_type = detail.product_type;
    _this27.detail.Unit_price = detail.Unit_price;
    _this27.detail.price_type = detail.price_type || 'retail';
    ...
    _this27.detail.retail_unit_price = baseRetail;
    _this27.detail.wholesale_unit_price = baseWholesale;
    _this27.detail.min_price = detail.min_price !== undefined ? detail.min_price : 0;
    _this27.detail.fix_price = detail.fix_price;
    _this27.detail.fix_stock = detail.fix_stock;
    _this27.detail.current = detail.current;
    ...
    _this27.detail.tax_method = rawTaxMethod === 2 || rawTaxMethod === '2' ? 2 : 1;
    _this27.detail.discount_Method = detail.discount_Method;
    _this27.detail.discount = detail.discount;
    _this27.detail.quantity = detail.quantity;
    _this27.detail.tax_percent = detail.tax_percent;
    _this27.detail.is_imei = detail.is_imei;
    _this27.detail.imei_number = detail.imei_number;
    _this27.detailLoading = false;
  });
}), "submit_Update_Detail", function submit_Update_Detail() {
  var _this28 = this;
  ...
  this.CalculTotal();
  setTimeout(function () {
    _this29.$bvModal.hide("form_Update_Detail");
  }, 1000);
  ...
  return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
    ...
    return _regenerator().w(function (_context1) {
      while (1) switch (_context1.p = _context1.n) {
        case 0:
          _this30.client_name = '';
          _this30.selectedClientPoints = 0;
          _this30.points_to_convert = 0;
          _this30.discount_from_points = 0;
          _this30.used_points = 0;
          _this30.clientIsEligible = false;
          _this30.pointsConverted = false;
          _this30.sale.discount = 0;
          _this30.selectedClientCreditLimit = 0;
          _this30.selectedClientNetBalance = 0;
          if (selectedClientId) {
            _context1.n = 1;
            break;
          }
          _this30.selectedClientId = "";
          _this30.CalculTotal();
          return _context1.a(2);
        case 1:
          client = _this30.clients.find(function (c) {
          ...
          _this30.client_name = client.name;
          _this30.selectedClientId = selectedClientId;
          _context1.p = 2;
          _context1.n = 3;
        ...
        case 3:
          ...
          data = response.data;
          if (data.is_royalty_eligible) {
            _this30.selectedClientPoints = data.points;
            _this30.clientIsEligible = true;
          } else {
            _this30.selectedClientPoints = 0;
            _this30.clientIsEligible = false;
          }
        ...
        case 6:
          ...
          _this30.selectedClientCreditLimit = parseFloat(briefData.credit_limit || 0);
          _this30.selectedClientNetBalance = parseFloat(briefData.netBalance || 0);
          _context1.n = 8;
          break;
        case 7:
          _context1.p = 7;
  ...
  axios.get("sales_print_invoice/".concat(id)).then(function (response) {
    _this31.invoice_pos.sale = response.data.sale || {};
    // Backward compatibility: ensure discount_Method defaults to '2' (fixed) if not present
    if (_this31.invoice_pos.sale && !_this31.invoice_pos.sale.discount_Method) {
      _this31.invoice_pos.sale.discount_Method = '2';
    }
    _this31.invoice_pos.details = response.data.details;
    _this31.invoice_pos.setting = response.data.setting;
    _this31.invoice_pos.symbol = response.data.symbol;
    _this31.invoice_pos.zatca_qr = response.data.zatca_qr;
    _this31.payments = response.data.payments;
    if (response.data.pos_settings) {
      // Merge with existing pos_settings to preserve defaults
      _this31.pos_settings = _objectSpread(_objectSpread({}, _this31.pos_settings), response.data.pos_settings);
      // Convert integer values to boolean for proper condition checking
      if (typeof _this31.pos_settings.quick_add_customer === 'number') {
        _this31.pos_settings.quick_add_customer = _this31.pos_settings.quick_add_customer === 1;
      }
    }
    // Mirror index_sale behavior: show modal first, then optionally auto-print
    setTimeout(function () {
      try {
        _this31.$bvModal.show('Show_invoice');
      } catch (e) {}
      _this31.$nextTick(function () {
        return _this31.renderZatcaQrPos();
      });
    }, 500);
    ...
    try {
      var rawPrintable = _this31.pos_settings && _this31.pos_settings.is_printable !== undefined ? _this31.pos_settings.is_printable : response.data.pos_settings && response.data.pos_settings.is_printable !== undefined ? response.data.pos_settings.is_printable : 1;
  ...
  try {
    ...
    var draw = function draw() {
      try {
        ...
        var text = String(_this32.invoice_pos.zatca_qr || '');
        try {
          var m = _this32.$refs.zatcaQrcodePos;
  ...
  this.$refs.Create_Customer && this.$refs.Create_Customer.validate().then(function (success) {
    if (!success) {
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      _this33.makeToast("danger", _this33.$t("Please_fill_the_form_correctly"), _this33.$t("Failed"));
    } else {
      _this33.Create_Client();
    }
  })["catch"](function () {
  ...
  axios.post("clients", {
    ...
    _this34.clients.push({
      id: newClient.id,
      name: newClient.name
    });
    _this34.selectedClientId = newClient.id;
    _this34.client_name = newClient.name;
    _this34.onClientSelected(newClient.id);
    _this34.makeToast("success", _this34.$t("Successfully_Created"), _this34.$t("Success"));
    _this34.Get_Client_Without_Paginate();
    _this34.$bvModal.hide("New_Customer");
  })["catch"](function () {
    nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    _this34.makeToast("danger", _this34.$t("InvalidData"), _this34.$t("Failed"));
  });
  ...
  this.$refs.Quick_Add_Customer_Form && this.$refs.Quick_Add_Customer_Form.validate().then(function (success) {
    if (!success) {
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      _this35.SubmitProcessing = false;
      _this35.makeToast("danger", _this35.$t("Please_fill_the_form_correctly"), _this35.$t("Failed"));
      return;
    }
    axios.post("clients", {
      name: _this35.client.name,
      email: _this35.client.email || '',
      phone: _this35.client.phone || '',
      tax_number: _this35.client.tax_number || '',
      country: _this35.client.country || '',
      city: _this35.client.city || '',
      adresse: _this35.client.adresse || '',
      is_royalty_eligible: _this35.client.is_royalty_eligible || false
    }).then(function (response) {
      ...
      var hasCustoms = clientId && _this35.quickAddCustomFieldValues && Object.keys(_this35.quickAddCustomFieldValues).length > 0;
      var afterCustoms = function afterCustoms() {
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        _this35.SubmitProcessing = false;
        _this35.clients.push({
          id: newClient.id,
          name: newClient.name,
          phone: newClient.phone || ''
        });
        _this35.selectedClientId = newClient.id;
        _this35.client_name = newClient.name;
        _this35.onClientSelected(newClient.id);
        _this35.makeToast("success", _this35.$t("Successfully_Created"), _this35.$t("Success"));
        _this35.Get_Client_Without_Paginate();
        _this35.$bvModal.hide("Quick_Add_Customer");
        _this35.reset_Form_client();
        _this35.quickAddCustomFieldValues = {};
      };
      if (hasCustoms) {
        axios.post("custom-field-values", {
          entity_type: "App\\Models\\Client",
          entity_id: clientId,
          values: _this35.quickAddCustomFieldValues
  ...
  axios.get("get_today_sales").then(function (response) {
    _this37.today_sales = response.data;
    setTimeout(function () {
      _this37.$bvModal.show("modal_today_sales");
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    }, 1000);
  })["catch"](function () {});
      ...
      try {
        this.$nextTick(function () {
          ...
          if (!el) {
            ...
            try {
              _this38.$bvModal && _this38.$bvModal.show && _this38.$bvModal.show('Show_invoice');
            } catch (e) {}
  ...
  axios.get("pos/data_create_pos").then(function (response) {
    ...
    _this39.categories = response.data.categories;
    _this39.brands = response.data.brands;
    _this39.payment_methods = response.data.payment_methods;
    _this39.sale.warehouse_id = response.data.defaultWarehouse;
    _this39.selectedClientId = response.data.defaultClient;
    _this39.client_name = response.data.default_client_name;
    _this39.clientIsEligible = response.data.default_client_eligible === true || response.data.default_client_eligible === 1;
    _this39.selectedClientPoints = _this39.clientIsEligible ? parseFloat(response.data.default_client_points) : 0;
    _this39.point_to_amount_rate = response.data.point_to_amount_rate;

    // Set default tax from settings
    if (response.data.default_tax !== undefined && response.data.default_tax !== null) {
      _this39.sale.tax_rate = parseFloat(response.data.default_tax) || 0;
      _this39.CalculTotal();
    }
    _this39.product_perPage = response.data.products_per_page;
    _this39.languages_available = response.data.languages_available;

    // Hydrate company/receipt header info (also used for offline printing)
    try {
      if (response.data && response.data.setting) {
        var merged = _objectSpread(_objectSpread({}, _this39.invoice_pos && _this39.invoice_pos.setting ? _this39.invoice_pos.setting : {}), response.data.setting);
        _this39.invoice_pos.setting = merged;
        ...
        if (merged && typeof merged.invoice_format === 'string' && ['thermal', 'a4'].includes(merged.invoice_format)) {
          _this39.invoice_format = merged.invoice_format;
        } else {
          _this39.invoice_format = 'thermal';
        }
    ...
    try {
      var sym = _this39.currentUser && _this39.currentUser.currency ? _this39.currentUser.currency : '';
      if (!_this39.invoice_pos.symbol) {
        try {
          _this39.$set(_this39.invoice_pos, 'symbol', sym);
        } catch (e) {
          _this39.invoice_pos.symbol = sym;
        }
      }
    } catch (e) {}
    ...
    if (response.data.pos_settings) {
      _this39.pos_settings = response.data.pos_settings;
      // Convert integer values (0/1) to boolean for proper condition checking
      if (typeof _this39.pos_settings.quick_add_customer === 'number') {
        _this39.pos_settings.quick_add_customer = _this39.pos_settings.quick_add_customer === 1;
      }
      if (typeof _this39.pos_settings.barcode_scanning_sound === 'number') {
        _this39.pos_settings.barcode_scanning_sound = _this39.pos_settings.barcode_scanning_sound === 1;
      }
      if (typeof _this39.pos_settings.show_product_images === 'number') {
        _this39.pos_settings.show_product_images = _this39.pos_settings.show_product_images === 1;
      }
      if (typeof _this39.pos_settings.show_stock_quantity === 'number') {
        _this39.pos_settings.show_stock_quantity = _this39.pos_settings.show_stock_quantity === 1;
      }
      if (typeof _this39.pos_settings.enable_hold_sales === 'number') {
        _this39.pos_settings.enable_hold_sales = _this39.pos_settings.enable_hold_sales === 1;
      }
      if (typeof _this39.pos_settings.enable_customer_points === 'number') {
        _this39.pos_settings.enable_customer_points = _this39.pos_settings.enable_customer_points === 1;
      }
      if (typeof _this39.pos_settings.show_categories === 'number') {
        _this39.pos_settings.show_categories = _this39.pos_settings.show_categories === 1;
      }
      if (typeof _this39.pos_settings.show_brands === 'number') {
        _this39.pos_settings.show_brands = _this39.pos_settings.show_brands === 1;
      }
    }
    _this39.getProducts();
    _this39.paginate_Brands(_this39.brand_perPage, 0);
    _this39.paginate_Category(_this39.category_perPage, 0);
    _this39.stripe_key = response.data.stripe_key;
    ...
    try {
      ...
      if (cached) {
        _this39.clients = cached.clients || [];
        _this39.accounts = cached.accounts || [];
        _this39.warehouses = cached.warehouses || [];
        _this39.categories = cached.categories || [];
        _this39.brands = cached.brands || [];
        _this39.payment_methods = cached.payment_methods || [];
        if (!_this39.sale.warehouse_id && cached.defaultWarehouse) {
          _this39.sale.warehouse_id = cached.defaultWarehouse;
        }
        if (!_this39.selectedClientId && cached.defaultClient) {
          _this39.selectedClientId = cached.defaultClient;
        }
        if (!_this39.client_name && cached.default_client_name) {
          _this39.client_name = cached.default_client_name;
        }
        _this39.clientIsEligible = cached.default_client_eligible === true || cached.default_client_eligible === 1;
        _this39.selectedClientPoints = _this39.clientIsEligible ? parseFloat(cached.default_client_points || 0) : 0;
        _this39.point_to_amount_rate = cached.point_to_amount_rate || _this39.point_to_amount_rate;
        if (cached.default_tax !== undefined && cached.default_tax !== null) {
          _this39.sale.tax_rate = parseFloat(cached.default_tax) || 0;
          _this39.CalculTotal();
        }
        if (cached.products_per_page) {
          _this39.product_perPage = cached.products_per_page;
        }
        if (Array.isArray(cached.languages_available)) {
          _this39.languages_available = cached.languages_available;
        }
        if (cached.stripe_key) {
          _this39.stripe_key = cached.stripe_key;
        }
        ...
        try {
          ...
          if (setting) {
            _this39.invoice_pos.setting = _objectSpread(_objectSpread({}, _this39.invoice_pos && _this39.invoice_pos.setting ? _this39.invoice_pos.setting : {}), setting);
          }
        } catch (e) {}
  ...
  try {
    if (evt && evt.offline && evt.payload) {
      ...
      var payments = Array.isArray(payload.payments) ? payload.payments.map(function (p) {
        var method = (_this40.payment_methods || []).find(function (m) {
  ...
  return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
    ...
    return _regenerator().w(function (_context10) {
      while (1) switch (_context10.p = _context10.n) {
        case 0:
          if (!_this41.offlineSyncInProgress) {
            _context10.n = 1;
            break;
          }
        ...
        case 4:
          ...
          _t0 = _context10.v;
        case 5:
          _this41.offlineSyncInProgress = true;
          ...
          _this41.offlineLastSyncError = null;
          syncedCount = 0;
          _context10.p = 6;
          if (!(!_utils__WEBPACK_IMPORTED_MODULE_4__["default"] || !_utils__WEBPACK_IMPORTED_MODULE_4__["default"].offlinePos || !_utils__WEBPACK_IMPORTED_MODULE_4__["default"].offlinePos.getOfflineSales)) {
            _context10.n = 7;
        ...
        case 11:
          ...
          if (!(isNetworkError && !_this41.isOnline)) {
            _context10.n = 12;
            break;
          }
        ...
        case 12:
          ...
          _this41.offlineLastSyncError = msg;
        ...
        case 14:
          _context10.p = 14;
          _this41.offlineSyncInProgress = false;
          _this41.refreshOfflineSalesCount();
          // Notify UI that POS offline sync has finished
          try {
            if (typeof window !== 'undefined' && window.Fire && window.Fire.$emit) {
              window.Fire.$emit('offline-sync:end', {
                syncedCount: syncedCount,
                lastError: _this41.offlineLastSyncError
              });
            }
          } catch (e) {}
          // Show same feedback as auto-sync handler
          _this41.handleAutoOfflineSyncResult({
            syncedCount: syncedCount,
            lastError: _this41.offlineLastSyncError
          });
  ...
  this.$watch('warehouses', function (ws) {
    _this42.warehouseOptions = (ws || []).map(function (w) {
      return {
        value: w.id,
        text: w.name
      };
    });
    if (!_this42.registerForm.warehouse_id && _this42.sale && _this42.sale.warehouse_id) {
      _this42.registerForm.warehouse_id = _this42.sale.warehouse_id;
    }
    // Always check current register after initial data load
    _this42.refreshCurrentRegister();
  });
  // refresh register when warehouse changes
  this.$watch(function () {
    return _this42.sale.warehouse_id;
  }, function () {
    _this42.registerForm.warehouse_id = _this42.sale.warehouse_id || '';
    _this42.refreshCurrentRegister();
  });
  ...
  Fire.$on("pay_now", function () {
    setTimeout(function () {
      ...
      if (Number(_this42.GrandTotal) < 0) {
        var msg = _this42.$t ? "".concat(_this42.$t('pos.Total_Payable'), " cannot be negative") : 'Total Payable cannot be negative';
        _this42.makeToast('warning', msg, _this42.$t ? _this42.$t('Warning') : 'Warning');
        // Complete the animation of the progress bar.
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
        return;
      }
      _this42.paymentLines = [{
        amount: parseFloat(_this42.GrandTotal.toFixed(2)),
        payment_method_id: 2
      }];
      _this42.globalPaymentNote = '';
      _this42.selectedAccount = null;
      _this42.$bvModal.show("Add_Payment");
  ...
  Fire.$on("event_delete_draft_sale", function () {
    ...
    var itemsOnCurrentPage = _this42.draft_sales.length;
    var pageToLoad = _this42.draft_sales_page;

    // If we're deleting the last item on a page that's not page 1, go to previous page
    if (itemsOnCurrentPage === 1 && _this42.draft_sales_page > 1) {
      pageToLoad = _this42.draft_sales_page - 1;
      _this42.draft_sales_page = pageToLoad;
    }
    _this42.get_Draft_Sales(pageToLoad);
    // Complete the animation of theprogress bar.
    setTimeout(function () {
      return nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    }, 500);
...
var render = function render() {
  ...
  }), _vm._v(" "), _vm.isQuickAddCustomerEnabled && _vm.isOnline ? _c("button", {
  ...
  }, [_vm._v(_vm._s(_vm.details.length) + " " + _vm._s(_vm.$t("pos.items")))]) : _vm._e()]), _vm._v(" "), _c("div", {
