    ...
    Submit_Quick_Add_Supplier: function Submit_Quick_Add_Supplier() {
      ...
      this.$refs.Quick_Add_Supplier_Form && this.$refs.Quick_Add_Supplier_Form.validate().then(function (success) {
        ...
        axios.post("providers", {
          name: _this0.supplier.name,
          email: _this0.supplier.email || "",
          phone: _this0.supplier.phone || "",
          tax_number: _this0.supplier.tax_number || "",
          country: _this0.supplier.country || "",
          city: _this0.supplier.city || "",
          adresse: _this0.supplier.adresse || ""
        }).then(function (_ref3) {
          var data = _ref3.data;
          nprogress__WEBPACK_IMPORTED_MODULE_1___default().done();
          _this0.SubmitProcessing = false;
          ...
          if (newSupplier && newSupplier.id) {
            _this0.suppliers.push({
              id: newSupplier.id,
              name: newSupplier.name,
              phone: newSupplier.phone || ""
            });
            _this0.purchase.supplier_id = newSupplier.id;
          }
          _this0.makeToast("success", _this0.$t("Successfully_Created"), _this0.$t("Success"));
          _this0.$bvModal.hide("Quick_Add_Supplier");
          _this0.reset_Form_supplier();
        })["catch"](function (error) {
          nprogress__WEBPACK_IMPORTED_MODULE_1___default().done();
          _this0.SubmitProcessing = false;
...
var render = function render() {
  ...
  }), _vm._v(" " + _vm._s(_vm.$t("submit")))]), _vm._v(" "), _vm.SubmitProcessing ? _vm._m(1) : _vm._e()], 1)], 1)], 1)], 1)], 1)], 1)], 1)], 1) : _vm._e(), _vm._v(" "), _c("validation-observer", {
